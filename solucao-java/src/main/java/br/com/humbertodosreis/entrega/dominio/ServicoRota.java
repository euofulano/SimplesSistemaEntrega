...
public class ServicoRota {
    ...
    public static void main(String[] args) {
        ...
        List<Rota> rotas2 = dao.buscarRotasPorMapa("SP");
        ...
        rotas[0] = new Rota(locais[0], locais[1], 10); // A B 10
        rotas[1] = new Rota(locais[1], locais[3], 15); // B D 15
        rotas[2] = new Rota(locais[0], locais[2], 20); // A C 20
        rotas[3] = new Rota(locais[2], locais[3], 30); // C D 30
        rotas[4] = new Rota(locais[1], locais[4], 50); // B E 50
        rotas[5] = new Rota(locais[3], locais[4], 30); // D E 30
        ...
        System.out.println(servico.getDistanciaPara("D"));
